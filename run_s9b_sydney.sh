#!/usr/bin/env bash
# S9B live runner
# S9 + edge<=1200 + abs(direction)>=2 + block DOWN UTC00-02/UTC13-15
set -euo pipefail
...
export BTC5M_LIVE_ENABLED=true
export BTC5M_LIVE_DRY_RUN=false
export BTC5M_ALLOW_LIVE_ORDERS=true
...
# S9B precision filters
export BTC5M_MAX_EDGE_BPS=1200
export BTC5M_MIN_ABS_DIRECTION_BPS=2.0
export BTC5M_BLOCK_DOWN_UTC00_02=true
export BTC5M_BLOCK_DOWN_UTC13_15=true

# Live order policy
export BTC5M_ORDER_TYPE=FAK
export BTC5M_EXIT_ORDER_TYPE=FOK
