#!/usr/bin/env bash
# S9_SYDNEY_HOLD_EXPIRY_TIMEBOX_V1
# small_sydney clone + time gate (UTC 8-24) + hold-to-expiry only
set -euo pipefail

cd /home/ubuntu/poly-live-s5

export BTC5M_LIVE_DB_PATH=/home/ubuntu/.local/share/arb-engine-live-s9/btc5m-s9-sydney.sqlite
...
exec /home/ubuntu/poly-live-s5/.venv/bin/python -m btc5m_strategy.arb.btc5m_live_s9
